...
import styles from "./LasorFilm.module.css"
...
const LasorFilm = ()=>{
    ...
    return (
        ...
        <div className={styles["lasor-film"]}>
            <div className={styles["lasor-film-table"]}>
                <table>
                    <thead>
                        <tr>
                            ...
                            <th style={{width:"200px"}}><label>ฟิล์ม</label></th>
                        </tr>
                    </thead>
                    ...
                    {orderHistory.map((item, index) => {
                        ...
                        return (
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="button" id="file-upload" style={{display:"none"}}/>
                                    <button type="button" onClick={()=>alert("Show image")}>View</button>
                                </td>
                                <td>
                                    <select style={{width: "100px", top: "25px", left: "-70px"}} name="status" id="status" value={item.filmStatus}onChange={(event) => onDetailChange(event.target.value, index, "filmStatus")}>
