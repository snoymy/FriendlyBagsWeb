...
const RecheckArtWork = ()=>{
    ...
    return (
        ...
        <div className={styles["recheck-artwork"]}>
            <div className={styles["recheck-artwork-table"]}>
                <table>
                    <thead>
                        <tr>
                    ...
                    {orderHistory.map((item, index) => {
                        ...
                        return (
                            ...
                            <tr>
                                ...
                                <td>
                                    <label style={{paddingLeft:"10px", paddingRight:"10px", width:""}}>{item.edit}</label>
                                </td>
                                <td>
